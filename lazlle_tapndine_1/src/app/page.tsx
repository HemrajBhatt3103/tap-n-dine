    ...
    <div className="min-h-screen overflow-x-hidden" style={{ backgroundColor: 'var(--lazlle-bg-light)', color: 'var(--lazlle-text-dark)' }}>
      ...
      <section id="features" className="bg-gray-50">
        <div className="responsive-section">
          <motion.div
            ...
            >
              ...
              <p className="responsive-text mx-auto">
                Tap-n-Dine is a QR-based ordering platform that lets your customers browse, order, and pay seamlessly from their table.
              </p>
            </motion.div>
          ...
          >
            <div 
              ref={menuScrollerRef}
              className="auto-scroll-container pb-4"
            >
              <div className="flex space-x-4" style={{ width: 'max-content' }}>
                {[
                  ...
                  { title: 'Table Service', desc: 'Order from your table', icon: Utensils },
                  { title: 'Easy Payment', desc: 'Secure online payments', icon: CreditCard },
        ...
        <div className="responsive-section">
          ...
          <div className="business-types-auto-scroll-container relative">
            ...
            <div 
              ...
              className="business-types-grid horizontal-scroll scrollbar-hide"
            >
      ...
      <section style={{ backgroundColor: '#ffffff' }}>
        <div className="responsive-section">
          ...
          <div className="how-it-works-auto-scroll-container relative">
            {/* Fade edges for smooth transition */}
            ...
            <div 
              ...
              className="how-it-works-grid horizontal-scroll scrollbar-hide"
            >
